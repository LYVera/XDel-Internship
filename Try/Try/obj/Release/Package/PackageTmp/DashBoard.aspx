            ...
            <div class="navbar-collapse">
                <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="DashBoard" class="active"><i class="fa fa-home nav_icon"></i>Dashboard</a>
                        </li>
                        <li>
                            <a href="Show"><i class="fa fa-cogs nav_icon"></i>Show</a>
                        </li>
                        <li class="">
                            <a href="Validate"><i class="fa fa-book nav_icon"></i>/Validate</a>
                        </li>
                        <li>
                            <a href="Prompt"><i class="fa fa-th-large nav_icon"></i>Prompt</a>
                        </li>
                        <li>
                            <a href="ManageUser"><i class="fa fa-user-o"></i>Manage User</a>
                        </li>
                        <li class="">
                            <a href="ManageCluster"><i class="fa fa-hand-lizard-o"></i>/Manage Cluster</a>
                        </li>
                        <li>
                            <a href="ManageDrivers"><i class="fa fa-bus"></i>Manage Drivers</a>
                        </li>
